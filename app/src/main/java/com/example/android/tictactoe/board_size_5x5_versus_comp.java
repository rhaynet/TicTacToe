...
import static com.example.android.tictactoe.versus_computer_activity.sComputerLetter;
import static com.example.android.tictactoe.versus_computer_activity.sPlayerLetter;
import static com.example.android.tictactoe.versus_computer_activity.sPlayerName;

public class board_size_5x5_versus_comp extends AppCompatActivity implements View.OnClickListener {
    private Button[] b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.board_size_5_x_5);
    ...
    public void onClick(View view) {
        ...
        if (view.isEnabled()) {
            ...
            if (count == 25 && computer_Turn && PlayersTurn) {
                final Dialog dialog = new Dialog(board_size_5x5_versus_comp.this);
    ...
    private void checkWinner() {
        ...
        if (b[1].getText() == b[7].getText() && b[1].getText() == b[13].getText() && b[1].getText() == b[19].getText() && !b[1].isEnabled()) {
            b[1].setBackgroundResource(R.color.checkmate);
            b[7].setBackgroundResource(R.color.checkmate);
            b[13].setBackgroundResource(R.color.checkmate);
            b[19].setBackgroundResource(R.color.checkmate);
            ...
            b[3].setBackgroundResource(R.color.checkmate);
            b[7].setBackgroundResource(R.color.checkmate);
            b[11].setBackgroundResource(R.color.checkmate);
            b[15].setBackgroundResource(R.color.checkmate);
            checkWhoWon();
            ...
            b[23].setBackgroundResource(R.color.checkmate);
            b[17].setBackgroundResource(R.color.checkmate);
            b[11].setBackgroundResource(R.color.checkmate);
            b[5].setBackgroundResource(R.color.checkmate);
            checkWhoWon();
            ...
            b[21].setBackgroundResource(R.color.checkmate);
            b[17].setBackgroundResource(R.color.checkmate);
            b[9].setBackgroundResource(R.color.checkmate);
            b[13].setBackgroundResource(R.color.checkmate);
            checkWhoWon();
            ...
            b[12].setBackgroundResource(R.color.checkmate);
            b[18].setBackgroundResource(R.color.checkmate);
            checkWhoWon();
            ...
            b[24].setBackgroundResource(R.color.checkmate);
            b[18].setBackgroundResource(R.color.checkmate);
            b[12].setBackgroundResource(R.color.checkmate);
            b[6].setBackgroundResource(R.color.checkmate);
            checkWhoWon();
...
//checking win from right to left
        ...
        for (int i = 0; i < 5; i++) {
            if (b[i + 5].getText() ==npl && b[i + 10].getText()==npl && b[i + 15].getText()==npl && b[i + 20].getText()==npl) {
                b[i+5].setBackgroundResource(R.color.checkmate);
                b[i+10].setBackgroundResource(R.color.checkmate);
                b[i+15].setBackgroundResource(R.color.checkmate);
                b[i+20].setBackgroundResource(R.color.checkmate);
                checkWhoWon();
                break;
...
//checking win from right to left for computer
    ...
    private void checkWhoWon() {
        if (count == 7 || count == 9 || count == 11 || count == 13 || count == 15 || count == 17 || count == 19 || count == 21 || count == 23 || count == 25) {
            ...
            Toast.makeText(board_size_5x5_versus_comp.this, NewPlayerName + " won", Toast.LENGTH_LONG).show();
            PlayerScore++;
            ...
            Toast.makeText(board_size_5x5_versus_comp.this, " Computer won", Toast.LENGTH_LONG).show();
            ComputerScore++;
    ...
    private void main_menu(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(board_size_5x5_versus_comp.this,MainActivity.class);
