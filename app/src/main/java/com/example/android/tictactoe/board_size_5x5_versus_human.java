...
public class board_size_5x5_versus_human extends AppCompatActivity implements View.OnClickListener {
    private int count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(board_size_5x5_versus_human.this,playerOne + " starts first ", Toast.LENGTH_LONG).show();
        b= new Button[25];
        for(int i =0;i<25;i++){
...
//checking win from right to left for O
    ...
    private void checkWhoWon(){
        if(count==1||count==3||count==5||count==7||count==9 || count==11 || count==13
            ...
            final Dialog dialog = new Dialog(board_size_5x5_versus_human.this);
            ...
            Toast.makeText(board_size_5x5_versus_human.this, playerOne + " wins ", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(board_size_5x5_versus_human.this, playerTwo, Toast.LENGTH_LONG).show();
    ...
    private void checkDraw(){
        if(count==25 && players){
            ...
            dialog.show();
            Toast.makeText(board_size_5x5_versus_human.this, "Its a draw!", Toast.LENGTH_LONG).show();
        }
    ...
    private void main_menu(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(board_size_5x5_versus_human.this,MainActivity.class);
