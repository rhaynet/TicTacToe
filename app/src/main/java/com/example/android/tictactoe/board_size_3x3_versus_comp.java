...
public class board_size_3x3_versus_comp extends AppCompatActivity implements View.OnClickListener {
    private int count = 0;
    private Button[] b;
    ...
    public void onClick(View view) {
        ...
        if (view.isEnabled()) {
            ...
            if (count == 9 && computer_Turn && PlayersTurn) {
                final Dialog dialog = new Dialog(board_size_3x3_versus_comp.this);
                ...
                dialog.show();
                Toast.makeText(board_size_3x3_versus_comp.this, " its a draw ", Toast.LENGTH_LONG).show();
    ...
    private void checkWinner() {
        ...
        for (int j = 0; j <= 2; j++) {
            if (b[j].getText() == b[j + 3].getText() && b[j].getText() == b[j + 6].getText() && !b[j].isEnabled()) {
                b[j].setBackgroundResource(R.color.checkmate);
                b[j+3].setBackgroundResource(R.color.checkmate);
                b[j+6].setBackgroundResource(R.color.checkmate);
                checkWhoWon();
                break;
            }
    ...
    */
    ...
    private void checkWhoWon() {
        ...
        if (count == 1 || count == 3 || count == 5 || count == 7 || count == 9) {
            ...
            Toast.makeText(board_size_3x3_versus_comp.this, NewPlayerName + " wins ", Toast.LENGTH_LONG).show();
            player1_Score++;
            ...
            Toast.makeText(board_size_3x3_versus_comp.this, " Computer wins ", Toast.LENGTH_LONG).show();
    ...
    private void main_menu(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(board_size_3x3_versus_comp.this,MainActivity.class);
